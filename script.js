    ...
    //  testimonials js
     ...
     const testimonials = [
        ...
        },
        {
            ...
            text: 'I had the pleasure of dining at Les Chèvres recently and it was an amazing experience. The staff were incredibly friendly and attentive, and the wait times were surprisingly quick. The reservations process was also smooth and straightforward. But the best part was the food - it was absolutely brilliant!'
        },
    ...
    // Set interval to automatically show the next testimonial every 3000 milliseconds (3 seconds)
